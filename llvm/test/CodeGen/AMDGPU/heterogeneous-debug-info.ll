...
; AFTER-PEI-DAG: ![[STACK_LIFETIME_VAR_R:[0-9]+]] = distinct !DILifetime(object: ![[VAR_R]], location: !DIExpr(DIOpReferrer(i32), DIOpConstant(i32 6), DIOpShr(), DIOpReinterpret(i32 addrspace(5)*), DIOpDeref(i32), DIOpConstant(i32 8), DIOpByteOffset(i32)))
...
entry:
  ...
  call void @llvm.dbg.def(metadata !15, metadata i32 addrspace(5)* %I.addr)
  %I.addr.ascast = addrspacecast i32 addrspace(5)* %I.addr to i32*
  %R = alloca i32, align 4, addrspace(5)
  call void @llvm.dbg.def(metadata !17, metadata i32 addrspace(5)* %R)
  %R.ascast = addrspacecast i32 addrspace(5)* %R to i32*
...
if.then:                                          ; preds = %entry
  %1 = load i32, i32* %I.addr.ascast, align 4
  %sub = sub nsw i32 0, %1
  store i32 %sub, i32* %R.ascast, align 4
  br label %if.end

if.else:                                          ; preds = %entry
  %2 = load i32, i32* %I.addr.ascast, align 4
  store i32 %2, i32* %R.ascast, align 4
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %3 = load i32, i32* %R.ascast, align 4
  ret i32 %3
}
...
!15 = distinct !DILifetime(object: !13, location: !DIExpr(DIOpReferrer(i32 addrspace(5)*), DIOpDeref(i32)))
!16 = !DILocalVariable(name: "R", scope: !9, file: !1, line: 2, type: !12)
!17 = distinct !DILifetime(object: !16, location: !DIExpr(DIOpReferrer(i32 addrspace(5)*), DIOpDeref(i32)))
